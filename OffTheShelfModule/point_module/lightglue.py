...
class LightGlue(nn.Module):
    ...
    def __init__(self, features="superpoint", **conf) -> None:
        ...
        if features is not None:
            ...
            if 'superpoint' in fname:
                state_dict = torch.load('/home/video/demo/CVPR/LightStab/point_module/weight/superpoint_lightglue.pth',
                                        weights_only=False)
            elif 'aliked' in fname:
                state_dict = torch.load('/home/video/demo/CVPR/LightStab/point_module/weight/aliked_lightglue.pth',
                    weights_only=False)
            elif 'sift' in fname:
                state_dict = torch.load('/home/video/demo/CVPR/LightStab/point_module/weight/sift_lightglue.pth',
                    weights_only=False)
            elif 'disk' in fname:
                state_dict = torch.load('/home/video/demo/CVPR/LightStab/point_module/weight/disk_lightglue.pth',
                    weights_only=False)
            elif 'doghardnet' in fname:
                state_dict = torch.load('/home/video/demo/CVPR/LightStab/point_module/weight/doghardnet_lightglue.pth',
                    weights_only=False)
            else:
