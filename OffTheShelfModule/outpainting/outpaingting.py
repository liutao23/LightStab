...
from outpainting.model.modules.flow_comp_raft import RAFT_bi
from outpainting.model.recurrent_flow_completion import RecurrentFlowCompleteNet
from outpainting.model.propainter import InpaintGenerator
from outpainting.utils.download_util import load_file_from_url
from outpainting.core.utils import to_tensors
from outpainting.model.misc import get_device
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-i', '--video', type=str, default='/media/B/论文投稿/CVPR数据/CVPR_end/CVPR_end_Results/our/DeepStab4crop.mp4',
        help='Path of the input video or image folder.')
    parser.add_argument(
        '-o', '--output', type=str, default='/media/B/论文投稿/CVPR数据/CVPR_end/CVPR_end_Results/our/results',
    ...
    parser.add_argument(
        '--scale_h', type=float, default=1.2, help='Outpainting scale of height.')
    parser.add_argument(
        '--scale_w', type=float, default=1.2, help='Outpainting scale of width.')
    parser.add_argument(
